         ...
         <div id="page-content" class="row  blocks-pre  ">
            <div id="region-main-box" class="region-main">
               <section id="region-main" class="region-main-content" aria-label="Content">
                  ...
                  <div class="course-content"><h2 class="accesshide">Topic outline</h2>
                  <ul class="topics"><li id="section-0" class="section main clearfix" role="region" aria-labelledby="sectionid-4743-title" data-sectionid="0" data-sectionreturnid="0"><div class="left side"></div><div class="right side">
                    <img class="icon spacer" width="1" height="1" alt="" aria-hidden="true" src="second_files/spacer.gif"></div>
                    <div class="content"><h3 id="sectionid-4743-title" class="sectionname accesshide"><span>
                        <a href="http://putrablastdk.upm.edu.my/course/view.php?id=4220#section-0">General</a></span></h3
                        ><div class="section_availability"></div><div class="summary"></div>
                        <ul class="section img-text"><li class="activity forum modtype_forum " id="module-30023"><div>
                            <div class="mod-indent-outer w-100"><div class="mod-indent"></div>
                    ...
                    <form>
                        ...
                        <p>Subject Code and Name: <?php echo $subject_code." ".$subject_name;?></p>
                        <p>Date:<input type="date" class="form-control"></p>
                      <p>Time:<input type="time" > - <input type="time"></p>
